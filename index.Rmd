...
## IMPORTANT NOTICE:
This example pipeline deviates from the final workflow used in the analysis presented in `MAIN_SDM_ANALYSIS.R` and is useful as an example to start from. However, plots and results presented herein may differ from the results of work to be published.
