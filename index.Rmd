...
github_repo: "https://github.com/MigicovskyLab/malus"
---
...
## IMPORTANT NOTICE:
This example pipeline deviates from the final workflow used in the analysis presented at <https://github.com/MigicovskyLab/malus> in `MAIN_SDM_ANALYSIS.R` and is useful as an example to start from. However, plots and results presented herein may differ from the results of work to be published.
...
7| `malus_gap.R` | Conservation gap analysis to assess the level of conservation of species
...
knitr::include_graphics(rep("C:/Users/terre/Documents/Acadia/Malus Project/maps/OLD/occurences/m_coronaria_pre_post_1970.jpeg"))
```
...
```{r, eval = TRUE, echo=FALSE, out.width= '600px'}
knitr::include_graphics(rep("C:/Users/terre/Documents/Acadia/Malus Project/maps/OLD/wclim/wclim_bio1.jpeg"))
```
...
```{r, eval = TRUE, echo=FALSE, out.width= '600px'}
knitr::include_graphics(rep("C:/Users/terre/Documents/Acadia/Malus Project/statistical analysis/colinearity/cor_wclim_colinearity.jpeg"))
```
...
```{r, eval = TRUE, echo=FALSE, out.width= '600px'}
knitr::include_graphics(rep("C:/Users/terre/Documents/Acadia/Malus Project/statistical analysis/colinearity/cor_dendo.jpeg"))
```
...
```{r, eval = TRUE, echo=FALSE, out.width= '600px'}
knitr::include_graphics(rep("C:/Users/terre/Documents/Acadia/Malus Project/statistical analysis/kernel plots/cor_3dKernel_presence.jpeg"))
```

```{r, eval = TRUE, echo=FALSE, out.width= '600px'}
knitr::include_graphics(rep("C:/Users/terre/Documents/Acadia/Malus Project/statistical analysis/kernel plots/cor_3dKernel_bg.jpeg"))
```
...
```{r, eval = TRUE, echo=FALSE, out.width= '600px'}
knitr::include_graphics(rep("C:/Users/terre/Documents/Acadia/Malus Project/statistical analysis/checkboard_aggregation/cor_cb_pr.jpeg"))
```
...
```{r, eval = TRUE, echo=FALSE, out.width= '600px'}
knitr::include_graphics(rep("C:/Users/terre/Documents/Acadia/Malus Project/statistical analysis/checkboard_aggregation/cor_cb_bg_3,3.jpeg"))
```

**6,6** aggregation

```{r, eval = TRUE, echo=FALSE, out.width= '600px'}
knitr::include_graphics(rep("C:/Users/terre/Documents/Acadia/Malus Project/statistical analysis/checkboard_aggregation/cor_cb_bg_6,6.jpeg"))
```

**9,9** aggregation, which I chose to use!

```{r, eval = TRUE, echo=FALSE, out.width= '600px'}
knitr::include_graphics(rep("C:/Users/terre/Documents/Acadia/Malus Project/statistical analysis/checkboard_aggregation/cor_cb_bg_9,9.jpeg"))
```

**12,12** aggregation

```{r, eval = TRUE, echo=FALSE, out.width= '600px'}
knitr::include_graphics(rep("C:/Users/terre/Documents/Acadia/Malus Project/statistical analysis/checkboard_aggregation/cor_cb_bg_12,12.jpeg"))
```
...
knitr::include_graphics(rep("C:/Users/terre/Documents/Acadia/Malus Project/maps/OLD/habitat suitability/Predicted Suitability/raw model prediction/coronaria_historical_raw.jpeg"))
```
...
```{r, eval = TRUE, echo=FALSE, out.width= '1000px'}
knitr::include_graphics(rep("C:/Users/terre/Documents/Acadia/Malus Project/statistical analysis/boyce_index/corboyce_plot_malus_coronaria.png"))
```
...
knitr::include_graphics(rep("C:/Users/terre/Documents/Acadia/Malus Project/maps/OLD/habitat suitability/Predicted Suitability/coronaria_historical_bin.jpeg"))
```
...
```{r, eval = TRUE, echo=FALSE, out.width= '1500px'}
knitr::include_graphics(rep("C:/Users/terre/Documents/Acadia/Malus Project/maps/OLD/habitat suitability/Predicted Suitability/coronaria_ssp585_bin.jpeg"))
```
...
knitr::include_graphics(rep("C:/Users/terre/Documents/Acadia/Malus Project/maps/OLD/publication/suitability_legend.jpeg"))
```
...
knitr::include_graphics(rep("C:/Users/terre/Documents/Acadia/Malus Project/maps/OLD/publication/coronaria_historical.jpeg"))
```
...
```{r, eval = TRUE, echo=FALSE, out.width= '1500px'}
knitr::include_graphics(rep("C:/Users/terre/Documents/Acadia/Malus Project/maps/OLD/raw_figures/coronaria_habitat_suitability.jpg"))
```
...
```{r, eval = TRUE, echo=FALSE, out.width= '1500px'}
knitr::include_graphics(rep("C:/Users/terre/Documents/Acadia/Malus Project/maps/OLD/raw_figures/gap_scores/cor_in_situ_bar.jpeg"))
```
